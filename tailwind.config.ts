  ...
  theme: {
    extend: {
      fontSize: {
        ...
        "heading-4": [
          "2.4rem",
          { lineHeight: "3.2rem", letterSpacing: "-0.015em", fontWeight: "700" }
        ],
        "heading-5": [
          "2rem",
          { lineHeight: "2.4rem", letterSpacing: "-0.015em", fontWeight: "700" }
        ],
        "heading-6": [
          "1.6rem",
          { lineHeight: "2.4rem", letterSpacing: "-0.015em", fontWeight: "700" }
      ...
      colors: {
        ...
        "cta-hover": "#383838",
        "cta-hover-dark": "#cccccc",
        "secondary-hover-dark": "#1a1a1a",
        primary: {
          DEFAULT: "#5A4AF4",
          50: "#EBE9FE",
          100: "#DEDBFD",
